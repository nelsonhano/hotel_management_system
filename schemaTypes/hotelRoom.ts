...
const hotelRoom = {
    ...
    fields: [
        ...
        defineField({
            ...
            title: "Specila Note",
            type: "text",
            initialValue: "Check-in time is 12:00 PM, checkout time is 11:59 AM. If you leave anything behind, please contact the receptionist.",
            validation: Rule => Rule.required().min(10).error("Minimum 10 characters")
        }),
        defineField({
            name: "dimension",
            title: "Dimension",
